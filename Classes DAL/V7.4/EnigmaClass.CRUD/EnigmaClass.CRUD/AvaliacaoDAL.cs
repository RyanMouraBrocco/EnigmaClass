...
namespace EnigmaClass.CRUD
{
    public class AvaliacaoDAL
    {
        ...
        public void Inserir(Avaliacao A)
        {
            ...
            if (A.Denuncia == false)
            {
                comm.Parameters.Add("@Avalicao", SqlDbType.Bit).Value = A._Avaliacao;
            }
        ...
        public int AvaliacaoPossitiva(int pergunta, int resposta)
        {
            ...
            if (pergunta > 0)
            {
                comm.CommandText = "Select sum(ID_AvaliacaoPergunta) from AvaliacaoPergunta where ID_Pergunta = " + pergunta + " and Avaliacao_AvaliacaoPergunta = 1";
            }
            else
            {
                comm.CommandText = "Select sum(ID_AvaliacaoResposta) from AvaliacaoResposta where  ID_Resposta = " + resposta +" and Avaliacao_AvaliacaoResposta = 1";
            }
            int qtd = 0;
            try
            {
        ...
        public int AvaliacaoNegativa(int pergunta, int resposta)
        {
            ...
            if (pergunta > 0)
            {
                comm.CommandText = "Select sum(ID_AvaliacaoPergunta) from AvaliacaoPergunta where ID_Pergunta = " + pergunta + " and Avaliacao_AvaliacaoPergunta = 0 and Denuncia_AvaliacaoPergunta = 0";
            }
            else
            {
                comm.CommandText = "Select sum(ID_AvaliacaoResposta)  from AvaliacaoResposta where  ID_Resposta = " + resposta + " and Avaliacao_AvaliacaoResposta = 0 and Denuncia_AvaliacaoResposta = 0";
            }
            int qtd = 0;
            try
            {
        ...
        public int Denuncias(int pergunta, int resposta)
        {
            ...
            if (pergunta > 0)
            {
                comm.CommandText = "Select sum(ID_AvaliacaoPergunta) from AvaliacaoPergunta where ID_Pergunta = " + pergunta + " and Denuncia_AvaliacaoPergunta = 1";
            }
            else
            {
                comm.CommandText = "Select sum(ID_AvaliacaoResposta) from AvaliacaoResposta where  ID_Resposta = " + resposta + " and Denuncia_AvaliacaoResposta = 1";
            }
            int qtd = 0;
            try
            {
