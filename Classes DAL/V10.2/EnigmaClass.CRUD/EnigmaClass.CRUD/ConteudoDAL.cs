...
namespace EnigmaClass.CRUD
{
    public class ConteudoDAL
    {
        ...
        public void AlterarOrdem(Conteudo conteudo)
        {
            SqlCommand comm = new SqlCommand("Update Conteudo set Ordem_Conteudo = "+conteudo.Ordem+" Where ID_Conteudo = "+conteudo.ID,Banco.Abrir());
            comm.ExecuteNonQuery();
            comm.Connection.Close();
        }
        /// <summary>
